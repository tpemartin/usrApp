...
card$split_css$`cardLarge-background`$remain$`background-color`="#e9e9e9"
card$split_css$`cardLarge-background`$remain$`overflow` = "hidden"
card$split_css$`cardLarge-background-image`$remain$background = NULL
card$split_css$`cardLarge-background-image`$remain$`background-size`="auto 280px"
